...
const REQUEST_SPEC = {"method":"GET","path":"/api/todos"};
const MUTATION_REQUEST_SPECS = [{"method":"GET","path":"/api/todos/__shipflow_mutant__"},{"method":"POST","path":"/api/todos"},{"method":"GET","path":"/api/todos?__shipflow_mutant__=1"}];
...
test("api-get-todos: GET /api/todos returns the todo list", async ({ request }) => {
...
test("api-get-todos: GET /api/todos returns the todo list [mutation guard]", async ({ request }) => {

...
ShipFlow uses Codex native multi-agent roles from `.codex/config.toml` for specialist slices:
...
- keep each skill invocation tied to one verification slice and one evidence target

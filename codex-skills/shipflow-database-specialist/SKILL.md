...
Use this skill when the orchestrator delegates a persistence, query, or domain-data slice.
...
- If the blocker is actually transport/UI/runtime behavior, hand that dependency back to the orchestrator

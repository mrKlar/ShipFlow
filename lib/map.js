...
function recommendedFrameworks() {
  return {
    ui: ["playwright"],
    behavior: ["cucumber", "playwright-web", "playwright-request", "node-pty"],
    api: ["playwright-request", "pactum"],
    database: ["builtin-sql-harness", "pgtap"],
    performance: ["k6"],
    security: ["playwright-request", "owasp-zap"],
    technical: ["dependency-cruiser", "tsarch", "madge", "eslint-plugin-boundaries"],
  };
}

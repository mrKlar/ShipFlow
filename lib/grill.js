...
// Pure helpers (role guidance, prompt assembly, markdown rendering) live in
// ./grill-prompt.js. Direct consumers (tests, future call sites) should import
// from there. Only what this module needs at runtime is pulled in.
import {
  GRILL_ROLES,
  buildGrillPrompt,

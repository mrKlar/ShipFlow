...
export const ApiAssert = z.union([
  ...
  z.object({ header_matches: z.object({ name: z.string(), matches: z.string() }).strict() }).strict(),
  z.object({ body_contains: z.string() }).strict(),
  z.object({ json_equals: z.object({ path: z.string(), equals: z.unknown() }).strict() }).strict(),
  z.object({ json_matches: z.object({ path: z.string(), matches: z.string() }).strict() }).strict(),

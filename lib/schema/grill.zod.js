...
// Question/finding ids should be kebab-case so they can flow into URL
// segments, filenames, and structured indices without re-quoting.
const KEBAB_ID = z.string().regex(/^[a-z0-9](?:[a-z0-9-]*[a-z0-9])?$/, {

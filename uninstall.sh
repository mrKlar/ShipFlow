...
if [ -d "$HOME/.agents/skills/shipflow-draft" ] || [ -d "$HOME/.agents/skills/shipflow-impl" ] || [ -d "$HOME/.agents/skills/shipflow-implement" ]; then
  rm -rf "$HOME/.agents/skills/shipflow-draft" "$HOME/.agents/skills/shipflow-impl" "$HOME/.agents/skills/shipflow-implement"
  info "Skills removed"
else
...
if [ -d "$HOME/.kiro/skills/shipflow-draft" ] || [ -d "$HOME/.kiro/skills/shipflow-impl" ] || [ -d "$HOME/.kiro/skills/shipflow-implement" ]; then
  rm -rf "$HOME/.kiro/skills/shipflow-draft" "$HOME/.kiro/skills/shipflow-impl" "$HOME/.kiro/skills/shipflow-implement"
  info "Skills removed"
else

...
import { withTmpDir as tmpDir, withTmpDirAsync as tmpDirAsync } from "../util/tmp.js";
import { captureStdio } from "../util/stdio.js";

const withTmpDir = (fn) => tmpDir("shipflow-slices", fn);
const withTmpDirAsync = (fn) => tmpDirAsync("shipflow-slices", fn);
